...
public class Deque<Item> implements Iterable<Item> {
    ...
    public void pushLeft(Item item) {
        ...
        StdOut.println("left.prev" + left.prev + " left.item "+left.item + " left.next "+left.next);
        StdOut.println("right.prev" + right.prev + " right.item "+right.item + " right.next "+right.next);
        N++;
    }
